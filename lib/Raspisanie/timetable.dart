...
BaseList selectedRaspis = BaseList(name: selectedGroup.name, id: int.parse(selectedGroup.link), tabIndex: 0);
...
List<IconData> dropdownIcons = [
  ...
  getData() async {
    ...
    if (isConnected) {
      Uri uri = Uri.parse(urls[selectedRaspis.tabIndex] + selectedRaspis.id.toString());
                            ...
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                      textAlign: TextAlign.left,
                                      selectedRaspis.tabIndex == 1 ? raspPerDate[date]![listindex].groupname : raspPerDate[date]![listindex].auditory,
                                      style: TextStyle(
                                        fontSize: 16,
                                        color: Colors.white60,
                                      )),
                ...
                child: Padding(
                  ...
                  child: DropdownButton<String>(
                    ...
                    hint: Center(
                      ...
                      children: [
                        Text(
                          //ListInRaspisanie[idForRasp].toString(),
                          selectedRaspis.name,
                    ...
                    onChanged: (Object? value) {
                      if (value == 'search'){
                        Navigator.of(context).push(
                          MaterialPageRoute(
                              builder: ((context) => ChooseRaspisanie(funct: _changeSelectedRaspisanie,))),
                        );
                      } else {
                        if (value == selectedGroup.link){
                          selectedRaspis = savedRaspis[int.parse(value.toString())];
                        }
                        _changeSelectedRaspisanie(savedRaspis[int.parse(value.toString())]);
